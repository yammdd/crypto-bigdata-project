#!/usr/bin/env python3
"""
Diagnostic script to check data freshness and model behavior
"""
...
def check_data_freshness():
    ...
    for symbol in symbols:
        ...
        try:
            ...
            if days_old > 7:
                print(f"   ⚠️  WARNING: Data is more than a week old!")
            elif days_old > 1:
                print(f"   ⚠️  WARNING: Data is more than a day old!")
            else:
        ...
        try:
            ...
            if current_price:
                ...
                if pred_error < last_error:
                    ...
                    print(f"   ⚠️  Model prediction is worse than last price")
            ...
            if pred_diff > 20:
                print(f"   ⚠️  WARNING: Large difference between prediction and last price!")
